package com.dzakyhdr.fixholand.ui.fooddetail;
...
import com.dzakyhdr.fixholand.ui.comments.CommentFragment;
...
public class FoodDetailFragment extends Fragment implements TextWatcher {
                ...
                .subscribe(new SingleObserver<CartItem>() {
                    ...
                    public void onSuccess(CartItem cartItemFromDB) {
                        if (cartItemFromDB.equals(cartItem)) {
                            ...
                            //item tidak tersedia di dalam cart, memasukan baru
    ...
    private void displayAddonList() {
        if (Common.selectedFood.getAddon().size() > 0) {
            chip_group_addon.clearCheck(); //clear check all view
    ...
    private void calculateTotalPrice() {
        ...
        food_price.setText(new StringBuilder("").append(Common.formatPrize(displayPrice)).toString());
    }
